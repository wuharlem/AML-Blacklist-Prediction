...
def main(args):
    ...
    train_df['token_ids'] = train_df['sentences'].apply(lambda x: [tokenizer_chinese.encode(sentence) for sentence in x])
...
def _parse_args():
    ...
    parser.add_argument('--dataset', type=str, default = f'{os.getcwd()}/data/train.csv', 
                        help = 'the path of dataset')
    parser.add_argument('--save_path', type=str, default = f'{os.getcwd()}/model_1/pkl', 
